...
export default class DataTable extends LightningElement {
    ...
    connectedCallback(){
        ...
        window.console.log(`documentId: ${this.documentId}`)
        window.console.log(`dealProgram:  ${this.dealProgram}`)
        this.handleUploadFinished(this.documentId, this.dealProgram)
   }    


    //callback from csv file upload
    async handleUploadFinished(documentId, dealProgram) {
        window.console.log(`docid: ${documentId}, dp: ${dealProgram}`)
